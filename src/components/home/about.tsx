...
const About = () => {
    ...
    return (
        <div id="about">
            <pre className="title">About Me </pre>
            <div id="about-me-section">
                ...
                <div id="about-text">
                    ...
                    <br/><br/>
                        Some things I enjoy creating include deep learning models, programming languages, and web apps.
                    <br/><br/>
                    I revel in learning new things.
                </div>
            </div>
        </div>
    );
