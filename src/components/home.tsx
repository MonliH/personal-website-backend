                ...
                <div id="front-page">
                    <div id="title-page">
                        <div className="title-name-div">
                            <div className="name-title"><div>JONATHAN </div></div>
                            <div className="name-title"><div>LI </div></div>
                            <div className="subheading" id="subheading_name">I Delight in Coding</div>
                        </div>
                    </div>
